...
test.describe('seller profile review', () => {

test('check the seller profile review approval', async ({ page }) => {
    ...
    await expect(page).toHaveURL('http://192.168.15.80/Bagisto-v222/mp-v/public/customer/register');
 ...
 */
     ...
     */
    await expect(page).toHaveURL('http://192.168.15.80/Bagisto-v222/mp-v/public/');

    /**
     * Click the first product of the Feature Products Section on the Home Page
     */
    await page.waitForTimeout(2000);

    await page.click('(//div[contains(@class, "flex gap-8")])[2]/div/div[1]');
 ...
 */
     ...
     */
    await page.goto("http://192.168.15.80/Bagisto-v222/mp-v/public/admin/login");
     ...
     */
    await expect(page).toHaveURL("http://192.168.15.80/Bagisto-v222/mp-v/public/admin/dashboard");
     ...
     */ 
    await page.click("//a[@href='http://192.168.15.80/Bagisto-v222/mp-v/public/admin/marketplace/seller-reviews']");
    await page.waitForTimeout(2000);
