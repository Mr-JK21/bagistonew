...
return [
    ...
    'seller' => [
        ...
        'profile' => [
            'banner'              => 'באנר',
            'banner-description'  => 'העלה באנר ביחס של 13:3, גובה 375 אזור בטוח 375x250 מרכז בנייד',
            ...
            'info' => [
                'admin-commission-rate' => 'שיעור עמלת מנהל',
                'allowed-categories'    => 'קטגוריות מותרות',
                'allowed-product-type'  => 'סוג מוצר מותר',
                'commission-rate'       => ':rate% מסך כל הסכום בחשבונית',
