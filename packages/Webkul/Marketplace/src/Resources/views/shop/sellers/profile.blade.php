...
@php
    ...
    $reviews = $reviewRepository->getRecentReviews($seller->seller_id);
    ...
    @pushOnce('scripts')
        ...
        >
            <div class="max-sm:grid justify-between gap-y-4 rounded-2xl flex md:border md:p-5">
                ...
                <div class="flex">
                    ...
                    <form
                        ...
                        action="{{ route('shop.marketplace.sellers.show', $seller->shop_url) }}"
            ...
            <template v-if="activeTab == 'products'">
                <v-seller-products :search-term="searchTerm">
                    <x-marketplace::shop.shimmer.product />
                </v-seller-products>
            </template>
                ...
                <div class="mt-8 max-sm:grid gap-y-8 flex gap-x-8">
                    ...
                    <div class="grid w-full gap-y-5">
                        @foreach ($reviews as $review)
                            ...
                            @if ($loop->iteration == 5)
                                <a
                                    href="{{ route('shop.marketplace.seller.reviews.index', $seller->shop_url) }}"
                        ...
                        <x-shop::modal ref="reviewModal">
                            ...
                            <x-slot:footer>
                                <div class="flex justify-end">
                                    ...
                                    >
                                        @lang('marketplace::app.shop.sellers.profile.reviews.submit-btn')
                                    </button>
                                </div>
                            </x-slot:footer>
                        </x-shop::modal>
            ...
            app.component('v-seller-profile', {
                ...
                methods: {
                    createReview(params, { resetForm, setErrors }) {
                        ...
                        this.$axios.post("{{route('shop.marketplace.seller.reviews.store')}}", formData)
                            .then((response) => {
            ...
            app.component('v-seller-products', {
                ...
                methods: {
                    ...
                    getProducts() {
                        ...
                        this.$axios.get("{{ route('shop.marketplace.sellers.products', $seller->shop_url) }}", {
