    ...
    <body dir="{{ core()->getCurrentLocale()->direction }}">
        ...
        <div class="page">
            ...
            <div class="page-header">
                <b>{{ Str::upper(trans('marketplace::app.seller.orders.view.invoices.title')) }}</b>
            </div>
                ...
                <table class="{{ core()->getCurrentLocale()->direction }}">
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 50%; padding: 2px 18px;border:none;">
                                <b>
                                    @lang('marketplace::app.seller.orders.view.invoices.created-on', ['date_time' => ''])
                                </b>
                    ...
                    <thead>
                        <tr>
                            @if ($invoice->order->billing_address)
                                <th style="width: 50%;">
                                    <b>
                                        {{ ucwords(trans('marketplace::app.seller.orders.view.invoices.billed-to')) }}
                                    </b>
                                </th>
                            @endif
                            ...
                            @if ($invoice->order->shipping_address)
                                <th style="width: 50%">
                                    <b>
                                        {{ ucwords(trans('marketplace::app.seller.orders.view.invoices.shipped-to')) }}
                                    </b>
                                </th>
                            @endif
                        </tr>
                            ...
                            @foreach (['billing_address', 'shipping_address'] as $addressType)  
                                @if ($invoice->order->order->addressType)
                                    <td style="width: 50%">
                                        ...
                                        <div>@lang('marketplace::app.seller.orders.view.invoices.contact'): {{ $invoice->order->order->addressType->phone }}</div>
                                    </td>
                                @endif
                            @endforeach
                        </tr>
                        ...
                        <thead>
                            <tr>
                                @foreach (['sku', 'product-name', 'price', 'qty', 'subtotal', 'tax-amount', 'grand-total'] as $item)
                                    <th>
                                        @if ($item == 'sku') 
                                            @lang('marketplace::app.seller.orders.view.invoices.'.$item, ['sku' => ''])
                                        @else
                                            @lang('marketplace::app.seller.orders.view.invoices.'.$item)
                                        @endif
                                    </th>
                                @endforeach
                            </tr>
                ...
                <div class="summary">
                    <table class="{{ core()->getCurrentLocale()->direction }}">
                        <tbody>
                            @if (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'including_tax')
                                <tr>
                                    <td>@lang('marketplace::app.seller.orders.view.invoices.sub-total')</td>
                                    <td>-</td>
                                    <td>{!! core()->formatBasePrice($invoice->base_sub_total_incl_tax, true) !!}</td>
                                </tr>
                            @elseif (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
                                <tr>
                                    <td>@lang('marketplace::app.seller.orders.view.invoices.sub-total-incl-tax')</td>
                                    <td>-</td>
                                    <td>{!! core()->formatBasePrice($invoice->base_sub_total_incl_tax, true) !!}</td>
                                </tr>
                                
                                <tr>
                                    <td>@lang('marketplace::app.seller.orders.view.invoices.sub-total-excl-tax')</td>
                                    <td>-</td>
                            ...
                            @if (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'including_tax')
                                <tr>
                                    <td>@lang('marketplace::app.seller.orders.view.shipping-handling-incl-tax')</td>
                                    <td>-</td>
                            ...
                            @elseif (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'both')
                                ...
                                <tr>
                                    <td>@lang('marketplace::app.seller.orders.view.shipping-handling-excl-tax')</td>
                                    <td>-</td>
                                    <td>{!! core()->formatBasePrice(0, true) !!}</td>
                                </tr>
                            @else
