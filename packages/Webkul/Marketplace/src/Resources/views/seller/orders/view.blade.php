    ...
    <div class="flex items-center justify-between gap-4 max-xl:flex-wrap">
        ...
        <div class="flex items-center gap-2.5">
            ...
            @if (
                ...
                @include('marketplace::seller.orders.invoices.create')
            @endif
            ...
            @if (
                ...
                @include('marketplace::seller.orders.shipments.create')
            @endif
        ...
        <div class="max-sm:hidden">
            ...
            <x-shop::tabs class="mt-5 [&>*]:bg-[#FFFFFF]">
                <x-shop::tabs.item
                    ...
                    :is-selected="true"
                >
                    @include('marketplace::seller.orders.views.view')
                </x-shop::tabs.item>
                ...
                @if ($sellerOrder->invoices->count())
                    ...
                    >
                        @include('marketplace::seller.orders.views.invoice')
                    </x-shop::tabs.item>
                @endif
                ...
                @if ($sellerOrder->shipments->count())
                    ...
                    >
                        @include('marketplace::seller.orders.views.shipment')
                    </x-shop::tabs.item>
                @endif
                ...
                @if ($sellerOrder->refunds->count())
                    ...
                    >
                        @include('marketplace::seller.orders.views.refunds')
                    </x-shop::tabs.item>
                @endif
            </x-shop::tabs>
        </div>
