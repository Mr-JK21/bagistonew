<x-marketplace::seller.layouts>
    ...
    <x-marketplace::seller.form
        :action="route('seller.products.assign.update', $product->id)"
                        ...
                        <div class="flex flex-col items-start justify-between gap-y-2">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div
                                    @class([
                                        'py-1.5 px-2 flex items-center justify-center rounded',
                                        'bg-green-100' => $product->is_approved == 1,
                                        'bg-gray-200'  => $product->is_approved != 1,
                                    ])
                                >
                                    <span
                                        @class([
                                            'text-sm font-medium leading-4',
                                            'text-green-600' => $product->is_approved == 1,
                                            'text-gray-600'  => $product->is_approved != 1,
                                        ])
                                    >
                                        @if ($product->is_approved == 1)
                                            @lang('marketplace::app.seller.products.assign.product-details.approved')
                                        @else
                                            @lang('marketplace::app.seller.products.assign.product-details.disapproved')
                                        @endif
                                    </span>
                                </div>
                            </div>
