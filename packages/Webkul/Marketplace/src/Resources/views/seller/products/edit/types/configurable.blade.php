{!! view_render_event('bagisto.seller.product.edit.form.configurable_option.before', ['product' => $product]) !!}

<v-product-variations :errors="errors"></v-product-variations>

{!! view_render_event('bagisto.seller.product.edit.form.configurable_option.after', ['product' => $product]) !!}
        ...
        <div class="box-shadow relative rounded-xl border bg-white p-5">
            ...
            <div class="mb-4 grid grid-cols-3 justify-items-end gap-2.5">
                <div class="col-span-2 grid gap-2">
                    <p class="text-base font-semibold text-gray-800">
                        @lang('marketplace::app.seller.products.edit.types.configurable.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500">
                        @lang('marketplace::app.seller.products.edit.types.configurable.info')
                    </p>
                </div>
                ...
                >
                    @lang('marketplace::app.seller.products.edit.types.configurable.add-btn')
                </div>
            </div>
                ...
                <div class="grid justify-center justify-items-center gap-3.5 px-2.5 py-10">
                    ...
                    <div class="flex flex-col items-center">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('marketplace::app.seller.products.edit.types.configurable.empty-title')
                        </p>

                        <p class="text-gray-400">
                            @lang('marketplace::app.seller.products.edit.types.configurable.empty-info')
                        </p>
                    </div>
            ...
            >
                <form @submit="handleSubmit($event, addVariant)">
                    ...
                    <x-marketplace::seller.modal ref="variantCreateModal">
                        <!-- Modal Header -->
                        <x-slot:header>
                            <p class="text-2xl font-medium leading-10 text-[#151515]">
                                @lang('marketplace::app.seller.products.edit.types.configurable.create.title')
                            </p>
                        </x-slot:header>
                        ...
                        <x-slot:footer>
                            ...
                            <div class="flex justify-end">
                                ...
                                >
                                    @lang('marketplace::app.seller.products.edit.types.configurable.create.save-btn')
                                </button>
                            </div>
                        </x-slot:footer>
        ...
        <div class="flex items-center gap-1">
            ...
            <x-shop::dropdown v-bind:close-on-click="false">
                ...
                <x-slot:toggle>
                    ...
                    >
                        @lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.select-variants')
            ...
            <x-shop::dropdown v-if="selectedVariants.length">
                ...
                <x-slot:toggle>
                    <button
                        ...
                        class="flex cursor-pointer items-center rounded-md p-1.5 text-xs font-semibold text-navyBlue transition-all hover:bg-gray-100 focus:bg-gray-100"
                    >
                        @lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.select-action')
                    ...
                    >
                        ...
                        <x-slot:header>
                            <div class="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    type="submit"
                                >
                                    @lang('marketplace::app.seller.products.edit.types.configurable.edit.save-btn')
                                </button>
                            </div>
                        </x-slot:header>
                        ...
                        <x-slot:content class="p-4">
                                    ...
                                    <template v-if="selectedType == 'editPrices'">
                                        <div class="border-b pb-2.5">
                                            <div class="flex items-end gap-2.5">
                                                <x-marketplace::seller.form.control-group class="!mb-0 flex-1">
                                                    <x-marketplace::seller.form.control-group.label>
                                                        @lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.apply-to-all-sku')
                                                    </x-marketplace::seller.form.control-group.label>
                                                    ...
                                                    <x-marketplace::seller.form.control-group.control
                                                        ...
                                                        :label="trans('marketplace::app.seller.products.edit.types.configurable.mass-edit.price')"
                                                    />
                                                </x-marketplace::seller.form.control-group>

                                                <button class="secondary-button mt-2">
                                                    @lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.apply-to-all-btn')
                                                </button>
                                            </div>
                                    ...
                                    <template v-if="selectedType == 'editWeight'">
                                        <div class="border-b pb-2.5">
                                            <div class="flex items-end gap-2.5">
                                                <x-marketplace::seller.form.control-group class="!mb-0 flex-1">
                                                    <x-marketplace::seller.form.control-group.label>
                                                        @lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.apply-to-all-weight')
                                                    </x-marketplace::seller.form.control-group.label>
                                                    ...
                                                    <div class="relative">
                                                        <x-marketplace::seller.form.control-group.control
                                                            ...
                                                            value="0"
                                                            :label="trans('marketplace::app.seller.products.edit.types.configurable.mass-edit.weight')"
                                                        />
                                                    </div>
                                                </x-marketplace::seller.form.control-group>
                                            ...
                                            <x-marketplace::seller.form.control-group.error control-name="weight" />
                                        </div>
                                    </template>
                                    ...
                                    <template v-if="selectedType == 'editName'">
                                        <div class="border-b pb-2.5">
                                            <div class="flex items-end gap-2.5">
                                                <x-marketplace::seller.form.control-group class="!mb-0 flex-1">
                                                    <x-marketplace::seller.form.control-group.label>
                                                        @lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.apply-to-all-name')
                                                    </x-marketplace::seller.form.control-group.label>
                                                    ...
                                                    <div class="relative">
                                                        <x-marketplace::seller.form.control-group.control
                                                            ...
                                                            name="name"
                                                            ::rules="{ required: true }"
                                                            :label="trans('marketplace::app.seller.products.edit.types.configurable.mass-edit.name')"
                                                        />
                                                    </div>
                                                </x-marketplace::seller.form.control-group>
                                    ...
                                    <template v-if="selectedType == 'editStatus'">
                                        <div class="border-b pb-2.5">
                                            <div class="flex items-end gap-2.5">
                                                <x-marketplace::seller.form.control-group class="!mb-0 flex-1">
                                                    <x-marketplace::seller.form.control-group.label>
                                                        @lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.apply-to-all-status')
                                                    </x-marketplace::seller.form.control-group.label>
                                                    ...
                                                    <div class="relative">
                                                        <x-marketplace::seller.form.control-group.control
                                                            ...
                                                            name="status"
                                                            ::rules="{ required: true }"
                                                            :label="trans('marketplace::app.seller.products.edit.types.configurable.mass-edit.status')"
                                                        >
                                                            <option value="1">
                                                                @lang('marketplace::app.seller.products.edit.types.configurable.edit.enabled')
                                                            </option>

                                                            <option value="0">
                                                                @lang('marketplace::app.seller.products.edit.types.configurable.edit.disabled')
                                                            </option>
                                                        </x-marketplace::seller.form.control-group.control>
                                                    </div>
                                                </x-marketplace::seller.form.control-group>
                            ...
                            >
                                ...
                                <template v-if="selectedType == 'editPrices'">
                                    <x-marketplace::seller.form.control-group class="mb-0 max-w-[115px]">
                                        <div class="relative">
                                            <span class="absolute top-2 text-gray-500 ltr:left-4 rtl:right-4">
                                                {{ core()->currencySymbol(core()->getBaseCurrencyCode()) }}
                                            </span>

                                            <v-field
                                                type="text"
                                                class="flex min-h-10 w-full rounded-md border bg-white py-1.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400 ltr:pl-8 rtl:pr-8"
                                                :class="[errors['variants[variant_' + variant.id + ']'] ? 'border border-red-500' : '']"
                                                :name="'variants[variant_' + variant.id + ']'"
                                                :rules="{required: true, decimal: true, min_value: 0}"
                                                v-model="variant.price"
                                                label="@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.price')"
                                            >
                                            </v-field>
                                        </div>
                                ...
                                <template v-if="selectedType == 'editWeight'">
                                    <x-marketplace::seller.form.control-group class="mb-0 max-w-[115px] flex-1">
                                        <div class="relative">
                                            <v-field
                                                type="text"
                                                ...
                                                label="@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.weight')"
                                            >
                                            </v-field>
                                        </div>
                                    ...
                                    <x-marketplace::seller.form.control-group class="mb-0 max-w-[115px] flex-1">
                                        <div class="relative">
                                            <v-field
                                                ...
                                                label="@lang('marketplace::app.seller.products.edit.types.configurable.edit.enabled')"
                                            >
                                                <option value="1">
                                                    @lang('marketplace::app.seller.products.edit.types.configurable.edit.enabled')
                                                </option>
                                    ...
                                    >
                                        <div class="relative">
                                            <v-field
                                                ...
                                                label="@lang('marketplace::app.seller.products.edit.types.configurable.edit.variant-name')"
                                            >
                                            </v-field>
                                        </div>
                                ...
                                <template v-if="selectedType == 'editInventories'">
                                    <x-marketplace::seller.form.control-group class="mb-0 mt-2.5">
                                        <div class="mb-2.5 grid grid-cols-3 gap-4">
                                            <x-marketplace::seller.form.control-group
                                                class="!mb-0"
                                                v-for='inventorySource in inventorySources'
                                    ...
                                    >
                                        <div class="relative">
                                            <v-field
                                                ...
                                                ::rules="{ required: true, regex: /^([0-9]*[1-9][0-9]*(\.[0-9]+)?|[0]+\.[0-9]*[1-9][0-9]*)$/ }"
                                                v-model="variant.sku"
                                                label="@lang('marketplace::app.seller.products.edit.types.configurable.edit.variant-sku')"
                                                v-slugify
                                            >
                                            </v-field>
                                        </div>
    ...
    >
        <div class="flex justify-between gap-2.5 border-b border-slate-300 py-6">
            ...
            <div class="flex gap-2.5">
                ...
                >
                    <template v-if="! variant.images.length">
                        ...
                        <p class="absolute bottom-1 w-full text-center text-[6px] font-semibold text-gray-400">
                            @lang('marketplace::app.seller.products.edit.types.configurable.image-placeholder')
                        </p>
                    </template>
                ...
                <div class="grid place-content-start gap-1.5">
                    ...
                    <p class="text-gray-600">
                        @{{ "@lang('marketplace::app.seller.products.edit.types.configurable.sku')".replace(':sku', variant.sku) }}
                    </p>
            ...
            <div class="grid place-content-start gap-1 text-right">
                ...
                <p class="font-semibold text-gray-800">
                    @{{ "@lang('marketplace::app.seller.products.edit.types.configurable.qty')".replace(':qty', totalQty) }}
                </p>
                ...
                <div class="flex gap-2.5">
                    ...
                    <p
                        ...
                        @click="remove"
                    >
                        @lang('marketplace::app.seller.products.edit.types.configurable.delete-btn')
                    </p>
                    ...
                    <div>
                        ...
                        >
                            @lang('marketplace::app.seller.products.edit.types.configurable.edit-btn')
                        </p>
                            ...
                            <form @submit="handleSubmit($event, update)">
                                ...
                                >
                                    ...
                                    <x-slot:header>
                                        <div class="flex items-center justify-between">
                                            <p class="text-xl font-medium">
                                                @lang('marketplace::app.seller.products.edit.types.configurable.edit.title')
                                            </p>
                                    ...
                                    <x-slot:content>
                                        ...
                                        <x-marketplace::seller.form.control-group>
                                            <x-marketplace::seller.form.control-group.label class="required">
                                                @lang('marketplace::app.seller.products.edit.types.configurable.edit.name')
                                            </x-marketplace::seller.form.control-group.label>
                                            ...
                                            <x-marketplace::seller.form.control-group.control
                                                ...
                                                ::value="variant.name"
                                                rules="required"
                                                :label="trans('marketplace::app.seller.products.edit.types.configurable.edit.name')"
                                            />
                                        ...
                                        <x-marketplace::seller.form.control-group>
                                            <x-marketplace::seller.form.control-group.label class="required">
                                                @lang('marketplace::app.seller.products.edit.types.configurable.edit.sku')
                                            </x-marketplace::seller.form.control-group.label>
                                            ...
                                            <x-marketplace::seller.form.control-group.control
                                                ...
                                                rules="required"
                                                ::value="variant.sku"
                                                :label="trans('marketplace::app.seller.products.edit.types.configurable.edit.sku')"
                                            />
                                        ...
                                        <div class="mb-2.5 flex gap-4">
                                            <x-marketplace::seller.form.control-group class="flex-1">
                                                <x-marketplace::seller.form.control-group.label class="required">
                                                    @lang('marketplace::app.seller.products.edit.types.configurable.edit.price')
                                                </x-marketplace::seller.form.control-group.label>
                                                ...
                                                <x-marketplace::seller.form.control-group.control
                                                    ...
                                                    ::rules="{required: true, decimal: true, min_value: 0}"
                                                    ::value="variant.price"
                                                    :label="trans('marketplace::app.seller.products.edit.types.configurable.edit.price')"
                                                />
                                            ...
                                            <x-marketplace::seller.form.control-group class="flex-1">
                                                <x-marketplace::seller.form.control-group.label>
                                                    @lang('marketplace::app.seller.products.edit.types.configurable.edit.status')
                                                </x-marketplace::seller.form.control-group.label>
                                                ...
                                                <x-marketplace::seller.form.control-group.control
                                                    ...
                                                    rules="required"
                                                    ::value="variant.status"
                                                    :label="trans('marketplace::app.seller.products.edit.types.configurable.edit.status')"
                                                >
                                                    <option value="1">
                                                        @lang('marketplace::app.seller.products.edit.types.configurable.edit.enabled')
                                                    </option>
                                        ...
                                        <x-marketplace::seller.form.control-group>
                                            <x-marketplace::seller.form.control-group.label class="required">
                                                @lang('marketplace::app.seller.products.edit.types.configurable.edit.weight')
                                            </x-marketplace::seller.form.control-group.label>
                                            ...
                                            <x-marketplace::seller.form.control-group.control
                                                ...
                                                ::rules="{ required: true, regex: /^([0-9]*[1-9][0-9]*(\.[0-9]+)?|[0]+\.[0-9]*[1-9][0-9]*)$/ }"
                                                ::value="variant.weight"
                                                :label="trans('marketplace::app.seller.products.edit.types.configurable.edit.weight')"
                                            />
                                        ...
                                        <div class="mt-5 grid">
                                            <p class="mb-2.5 font-semibold text-gray-800">
                                                @lang('marketplace::app.seller.products.edit.types.configurable.edit.quantities')
                                            </p>
                                        ...
                                        <div class="mb-2.5">
                                            <p class="mb-2.5 font-semibold text-gray-800">
                                                @lang('marketplace::app.seller.products.edit.types.configurable.edit.images')
                                            </p>
                                        ...
                                        >
                                            @lang('marketplace::app.seller.products.edit.types.configurable.edit.edit-info')

                                            <a
                                                :href="'{{ route('seller.products.edit', ':id') }}'.replace(':id', variant.id)" 
                                                class="inline-block text-blue-500 hover:text-blue-600 hover:underline"
                                                target="_blank"
                                            >
                                                @lang('marketplace::app.seller.products.edit.types.configurable.edit.edit-link-title')
                                            </a>
                                        </div>
                                    </x-slot>
                                </x-marketplace::seller.drawer>
            ...
            methods: {
                addVariant(params, { resetForm }) {
                    ...
                    if (filteredVariants.length) {
                        this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('marketplace::app.seller.products.edit.types.configurable.create.variant-already-exists')" });
                ...
                return {
                    ...
                    updateTypes: {
                        editName: {
                            key: 'editName',
                            value: 'name',
                            title: "@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.edit-name')"
                        },

                        editSku: {
                            key: 'editSku',
                            value: 'sku',
                            title: "@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.edit-sku')"
                        },

                        editPrices: {
                            key: 'editPrices',
                            value: 'price',
                            title: "@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.edit-prices')"
                        },

                        editInventories: {
                            key: 'editInventories',
                            value: 'edit-inventories',
                            title: "@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.edit-inventories')"
                        },

                        editWeight: {
                            key: 'editWeight',
                            value: 'weight',
                            title: "@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.edit-weight')",
                        },

                        editStatus: {
                            key: 'editStatus',
                            value: 'status',
                            title: "@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.edit-status')",
                        },

                        addImages: {
                            key: 'addImages',
                            value: 'images',
                            title: "@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.add-images')",
                            images: []
                        },

                        removeImages: {
                            key: 'removeImages',
                            title: "@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.remove-images')",
                            value: 'remove-images',
                        },
                        ...
                        removeVariants: {
                            ...
                            title: "@lang('marketplace::app.seller.products.edit.types.configurable.mass-edit.remove-variants')",
                        }
                    },
                };
            },
