@php
    $assignedProduct = [];
    $variants = $baseProduct->variants()->get();
    $superAttribute = $baseProduct->super_attributes()->with('options')->get();

    if (isset($product)) {
        $assignedProduct = $product->with([
            'variants' => [
                'images',
                'product' => [
                    'inventories'
        ...
        app.component('v-product-variations', {
            ...
            data () {
                return {
                    ...
                    assignedProduct: @json($assignedProduct),

                    superAttributes: @json($superAttribute),
                }
            },
