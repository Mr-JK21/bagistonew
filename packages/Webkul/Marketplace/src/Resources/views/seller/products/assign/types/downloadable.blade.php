...
@pushOnce('scripts')
    <script type="text/x-template" id="v-downloadable-links-template">
        <div class="relative rounded-xl border bg-white p-4 mt-2.5">
            <!-- Panel Header -->
    ...
    <script type="module">
        app.component('v-downloadable-links', {
            ...
            data() {
                return {
                    links: @json(isset($product) ? $product->downloadable_links : []),
            ...
            methods: {
                ...
                uploadFile(type) {
                    ...
                    this.$axios.post("{{ route('admin.catalog.products.upload_link', $baseProduct->id) }}", formData, {
                        headers: {
        ...
        app.component('v-downloadable-samples', {
            ...
            data() {
                return {
                    samples: @json(isset($product) ? $product->downloadable_samples : []),
            ...
            methods: {
                ...
                uploadFile(type) {
                    ...
                    this.$axios.post("{{ route('admin.catalog.products.upload_sample', $baseProduct->id) }}", formData, {
                            headers: {
                                'Content-Type': 'multipart/form-data',
                                'X-CSRF-TOKEN': "{{ csrf_token() }}"
                            }
