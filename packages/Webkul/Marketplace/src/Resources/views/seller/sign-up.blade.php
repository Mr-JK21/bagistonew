                            ...
                            <div class="grid grid-cols-2 gap-y-3 gap-x-6">
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control type="text" class="rounded-lg !p-[20px_25px]"
                                        id="name" name="name" rules="required" :value="old('name')"
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control type="text" id="phone" name="phone"
                                        ...
                                        aria-label="@lang('marketplace::app.seller.signup.phone-number')" required />
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control type="text" class="rounded-lg !p-[20px_25px]"
                                        name="url" rules="required" :value="old('url')"
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control type="email" class="rounded-lg !p-[20px_25px]"
                                        name="email" id="email" rules="required|email" :value="old('email')"
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control type="text" class="rounded-lg !p-[20px_25px]"
                                        name="city" rules="required" :value="old('city')"
                                ...
                                <x-shop::form.control-group class="mb-6">
                                    ...
                                    <x-shop::form.control-group.control type="password"
                                        class="rounded-lg !p-[20px_25px]" name="password" rules="required|min:6"
                                        :value="old('password')"
                                        :label="trans('marketplace::app.seller.signup.password')"
                                        :placeholder="trans('marketplace::app.seller.signup.password')" ref="password"
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control type="password"
                                        class="rounded-lg !p-[20px_25px]" name="password_confirmation"
                                ...
                                <x-shop::form.control-group class="w-full">
                                    ...
                                    <x-shop::form.control-group.control type="select" name="country" rules="required"
                                        v-model="country"
                                ...
                                <x-shop::form.control-group class="w-full">
                                    ...
                                    <template v-else>
                                        <x-shop::form.control-group.control type="text" name="state" v-model="state"
                                            rules="required"
                                            :label="trans('marketplace::app.admin.sellers.index.create.state')"
                                            :placeholder="trans('marketplace::app.admin.sellers.index.create.state')" />
                                    </template>
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control type="text" class="rounded-lg !p-[20px_25px]"
                                        name="aadhar" maxlength="12" pattern="[0-9]{12}" :value="old('aadhar')"
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control type="text" class="rounded-lg !p-[20px_25px]"
                                        ...
                                        aria-label="@lang('marketplace::app.seller.signup.pan-card')" required />
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <div class="flex gap-x-4">
                                        ...
                                        <x-shop::form.control-group.control 
                                            ...
                                            aria-label="@lang('marketplace::app.seller.signup.gst-number')" required />
