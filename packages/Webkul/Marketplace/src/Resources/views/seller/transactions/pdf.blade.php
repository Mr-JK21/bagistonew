    ...
    <body style="background-image: none;background-color: #fff;">
        <div class="container">
            ...
            <div class="invoice-summary">
                ...
                <div class="row">
                    <span class="label">@lang('marketplace::app.seller.transactions.view.id') -</span>
                    <span class="value">#{{ $transaction->transaction_id }}</span>
                </div>

                <div class="row">
                    <span class="label">@lang('marketplace::app.seller.transactions.view.method') -</span>
                    <span class="value">{{ $transaction->method }}</span>
                </div>

                <div class="row">
                    <span class="label">@lang('marketplace::app.seller.transactions.view.date') -</span>
                ...
                <div class="items table">
                    <table>
                        <thead>
                            <tr>
                                <th>@lang('marketplace::app.seller.transactions.view.name')</th>
                                <th>@lang('marketplace::app.seller.transactions.view.price')</th>
                                <th>@lang('marketplace::app.seller.transactions.view.qty')</th>
                                <th>@lang('marketplace::app.seller.transactions.view.total')</th>
                                <th>@lang('marketplace::app.seller.transactions.view.commission')</th>
                                <th>@lang('marketplace::app.seller.transactions.view.seller-total')</th>
                            </tr>
                        </thead>
                ...
                <table class="sale-summary">
                    <tr>
                        <td>@lang('marketplace::app.seller.transactions.view.subtotal')</td>
                        <td>-</td>
                        <td>{{ core()->formatBasePrice($transaction->order->base_sub_total) }}</td>
                    </tr>

                    @if ($transaction->order->order->haveStockableItems())
                    <tr>
                        <td>@lang('marketplace::app.seller.transactions.view.shipping-handling')</td>
                        <td>-</td>
                    ...
                    <tr>
                        <td>@lang('marketplace::app.seller.transactions.view.tax')</td>
                        <td>-</td>
                        <td>{{ core()->formatBasePrice($transaction->order->base_tax_amount) }}</td>
                    </tr>

                    <tr>
                        <td>@lang('marketplace::app.seller.transactions.view.commission')</td>
                        <td>-</td>
                        <td>{{ core()->formatBasePrice($transaction->order->base_commission) }}</td>
                    </tr>

                    <tr class="">
                        <td>
                            <b> @lang('marketplace::app.seller.transactions.view.seller-total') </b>
                        </td>
                        <td>-</td>
                        <td>
                            <b> {{ core()->formatBasePrice($transaction->order->base_seller_total) }} </b>
                        </td>
                    </tr>
                </table>
