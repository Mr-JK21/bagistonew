...
class InvoiceController extends Controller
{
    ...
    public function store(int $orderId)
    {
        ...
        if (! $sellerOrder->canInvoice()) {
            session()->flash('error', trans('marketplace::app.seller.orders.invoices.permission-error'));
        ...
        if (! $haveProductToInvoice) {
            session()->flash('error', trans('marketplace::app.seller.orders.invoices.qty-error'));
        ...
        session()->flash('success', trans('marketplace::app.seller.orders.invoices.invoice-success'));
    ...
    public function print(int $id)
    {
        ...
        return $this->downloadPDF(
            view('marketplace::seller.orders.invoices.pdf', compact('invoice'))->render(),
