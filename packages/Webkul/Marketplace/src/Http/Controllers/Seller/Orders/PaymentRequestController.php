...
class PaymentRequestController extends Controller
{
    ...
    public function requestPayment(int $id)
    {
        Validator::make([
            ...
            'id' => 'required|exists:marketplace_orders,id,status,completed,marketplace_seller_id,'.seller()->user()->id,
        ])->validated();
        ...
        if ($order
            ...
            session()->flash('success', trans('marketplace::app.seller.orders.index.payment-req-success'));
        }
