...
class ShipmentController extends Controller
{
    ...
    public function store(int $orderId)
    {
        ...
        if (! $sellerOrder->canShip()) {
            session()->flash('error', trans('marketplace::app.seller.orders.shipments.permission-error'));
        ...
        if (! $this->isInventoryValidate($data)) {
            session()->flash('error', trans('marketplace::app.seller.orders.shipments.qty-error'));
        ...
        session()->flash('success', trans('marketplace::app.seller.orders.shipments.shipment-success'));
